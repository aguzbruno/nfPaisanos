    ...
    return <div className={styles.nftDetailContainer} >
        <div className={styles.imgPrincipalContainer}>
            ...
            <Magnifier
                ...
                magnifierRadius={100}
                />
                <div className={styles.hoverToZoom}>Hover to zoom<Image src='/zoom.svg' width={18} height={18} alt="zoom-image"/></div>
        ...
        <div className={styles.infoNftDetailContainer} >
            ...
            <BidDetail selectedFavorite={selectedFavorite} ethPrice={ethPrice} />
            <ButtonsDetail />
            <Arrows />
        </div>
    </div>;
