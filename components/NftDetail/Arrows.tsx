...
export default function Arrows() {
    ...
    const { favoritesNfts, setSelectedFavorite } = useNftStore((state) => state)
    ...
    return <div className={styles.arrowContainer} >
        <Image onClick={() => { handleArrow('left') }} style={{ cursor: "pointer" }} src="/arrow.svg" alt="flecha izquierda" width={40} height={40} />
        <div className={styles.rightArrowCircle} >
            <Image onClick={() => { handleArrow('right') }} style={{ rotate: "180deg", cursor: "pointer" }} src="/arrow.svg" alt="flecha derecha" width={40} height={40} />
        </div>
    </div>
};
