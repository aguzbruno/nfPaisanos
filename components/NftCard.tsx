...
const NftCard: React.FC<Props> = ({ nft }) => {
    ...
    return (
        ...
        >
            <Image
                className={styles.imgPrincipalNftCard}
                width={287}
                height={303}
                src={nft.media.image}
                alt="principal-image-nft"
            />
            {isHover ? (
                <div
                ...
                >
                    <label className={styles.typeNft}>
                        {nft.attributes.type.toUpperCase()}
                    </label>
            ...
            <div className={styles.allInfoContainer}>
                        ...
                        {nft.bidUsers.map((biduser, i) => {
                            return (
                                <Image
                                    ...
                                    width={24}
                                    height={24}
                                    className={styles.bidUsersPerfil}
                                    alt="bidUsers"
                                />
                            );
                        })}
                ...
                <div
                    className={`${styles.containerBidsCard} ${styles.borderTop}`}
                >
                    <div className={`${styles.row} ${styles.center}`}>
                        <p className={styles.titleBid}>
                            <Image
                        ...
                        <p
                            className={
                                nft.highestBid.length > 10
                                    ? styles.highBidShorter
                                    : styles.highBid
                            }
                        >
                            {nft.highestBid}
